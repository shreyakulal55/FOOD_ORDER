...
mongoose.connect("mongodb+srv://shreyakulal55:shreyakulal55@skilllabfood.vy1r4i4.mongodb.net/");
...
app.post("/add-order", async (req, res) => {
  try {
    ...
    const paymentDetailsResponse = await fetch("http://localhost:4000/mock-payment", {
      method: "POST",
      headers: {
